...
import { CvAnalysisSectionFlags, IndustryScore, JobRecommendation, ResultApiResponse, ResultBigFive, ResultSection, Resume } from "@/shared/types/chanci/result";
...
const Page = () => {
  ...
  return (
    <>
      ...
      {loading ? <div style={{ backgroundColor: 'rgba(0, 0, 0, 0.49)', width: '100%', height: '100vh' }}>
      </div>
        : <ChanciContainer SideBar={<DynamicSidebar
          sections={sections}
          activeSection={activeSection}
          onSectionChange={handleSectionChange}
          drawer={false}
        />}>
          {jobRecommendation && <DynamicResultView
